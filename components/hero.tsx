...
export function Hero() {
  ...
  // 초기 데이터 - 배열 형태로 변경
  const defaultSocialLinks = [{"name":"Instagram","icon":"instagram","url":"https://www.instagram.com/2ueilll/"}]
  ...
  const defaultInfo = {
    ...
    background: {"image":"/uploads/hero-background-1765103155245.png","video":"","color":"","opacity":1}
  }
